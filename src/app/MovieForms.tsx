...
const MovieForms = () => {  
 ...
 const simpanData = async () => {
  ...
  if (fileInputRef.current && <fileInputRef className="current files"></fileInputRef> && fileInputRef.current.files[0]) {
...
<form className='gradient-custom P-8'  onSubmit={simpanData}>
  ...
  <div className="form-group row">
    ...
    <div className="col-sm-10">
      ...
      <input type="text"  className="form-control-plaintext  form-control bg-light form-control-sm" id="sutradaa" 
                    value={sutradara}
